 ...
 * @author miaoxuebing
 * @Description: TODO
 * @date 2020/9/29 9:32 上午
 */
public class TestAllMap {
    //平时开发常用到的map有以下几种：HashMap，TreeMap，Hashtable, LinkedHashMap
    //Map的初始化 Map maps = new HashMap(); Map maps = null;
    //插入元素、获取元素、删除元素、清空map map.put(key,value)； map.get(key)； map.remove(key)； map.clear();
    //下面就开始四中map读取性能做个比较，代码如下
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 10; i++) {
            ...
            TestAllMap test = new TestAllMap();
